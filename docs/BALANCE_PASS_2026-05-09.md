...
simulation. Crit multiplier moved from hardcoded 1.6× to a derived stat.
...
- Rares account for ~47% of spell drops via 8× multiplier — rare-drop identity confirmed.
...
- Effect: meaningful survivability improvement without trivialising content.
